<?php
class NetPublica_Dragonpay_Model_Standard extends Mage_Payment_Model_Method_Abstract {
	
   

        protected $_code = 'dragonpay';
        
        protected $_formBlockType = 'dragonpay/form_dragonpay';
        protected $_infoBlockType = 'dragonpay/info_dragonpay';
	...
	public function getOrderPlaceRedirectUrl() {
		return Mage::getUrl('dragonpay/payment/redirect', array('_secure' => true));
}
